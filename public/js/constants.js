...
// Initialize Firebase - Use config from external file
const config = window.getConfig ? window.getConfig('firebase') : {
...
if (typeof firebase !== 'undefined') {
  ...
  console.warn('Firebase not loaded - authentication features will be disabled');
}
